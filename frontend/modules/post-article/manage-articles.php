...
<head>
  ...
  <!--  <script language="javascript" src="../../js/foundation.min.js" type="text/javascript"></script>
   <script language="javascript" src="../../js/jquery.foundation.topbar.js" type="text/javascript"></script>
   -->
