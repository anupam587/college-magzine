...
{
	$query = mysql_query('INSERT INTO `article`(`category`, `title`, `content`,`authors`,`userid`) VALUES (\''.$_POST['category'].'\',\''.$_POST['title'].'\',\''.$_POST['content'].'\',\''.$_POST['authors'].'\',\''.$_SESSION['userID'].'\')');
